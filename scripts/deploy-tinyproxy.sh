...
BOSH_CLIENT=bosh_admin BOSH_CLIENT_SECRET="$(get_bosh_secret)" bosh-cli -n -e "${BOSH_ENVIRONMENT}" update-cloud-config "$cloud_config_file" -l "${KUBO_ENVIRONMENT_DIR}/director.yml"
