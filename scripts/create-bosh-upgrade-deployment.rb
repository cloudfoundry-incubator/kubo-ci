...
ops_files = '-o git-kubo-release/manifests/ops-files/rename.yml\
 -o git-kubo-release/manifests/ops-files/vm-types.yml\
 -o git-kubo-release/manifests/ops-files/misc/dev.yml \
...
vars = "-v deployment_name=#{ENV['DEPLOYMENT_NAME']} -v worker_vm_type=worker -v master_vm_type=master -v apply_addons_vm_type=minimal -v disk_size=10120"
